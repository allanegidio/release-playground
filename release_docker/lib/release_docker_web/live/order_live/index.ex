defmodule ReleaseDockerWeb.OrderLive.Index do
  use ReleaseDockerWeb, :live_view

  alias ReleaseDocker.Orders
  alias ReleaseDocker.Orders.Order
  ...
  @impl true
  def handle_info({ReleaseDockerWeb.OrderLive.FormComponent, {:saved, order}}, socket) do
